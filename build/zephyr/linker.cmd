...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x10000000 + 0x0), LENGTH = (2048*1K - 0x0)
    RAM (wx) : ORIGIN = 0x8000000, LENGTH = (1024 * 1K)
...
KEEP(*(.cy_sharedmem))
    ...
    __kernel_ram_end = 0x8000000 + (1024 * 1K);
